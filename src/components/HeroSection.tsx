    ...
    <section className="relative min-h-screen flex items-center justify-center legal-gradient text-white overflow-hidden pt-20 md:pt-16">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("https://media.licdn.com/dms/image/v2/D4E03AQFBk42ekckz8A/profile-displayphoto-shrink_800_800/B4EZcK3COhHsAc-/0/1748233890267?e=1755129600&v=beta&t=FpS5UDPJc1HaGNcJGgIkBShyfE-DNulLTMQ7ofIahWA")`,
        }} />
      </div>
